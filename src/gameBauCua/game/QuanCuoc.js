        ...
        <div className='mt-3 text-center'>
            <img src={quanCuoc.hinhAnh} style={{width:'250px'}}/>
                <div className=' bg-success mt-2 pb-2 text-center' style={{borderRadius:'10px',width:250,display:'inline-block'}}>
                    ...
                    }} className='btn btn-danger mr-3 mt-2' style={{fontSize:27}}><i class="fa-solid fa-plus"></i></button>
                    ...
                    }} className='btn btn-danger ml-3 mt-2' style={{fontSize:27}}><i class="fa-solid fa-minus"></i></button>
                </div>
        </div>
    );
}
